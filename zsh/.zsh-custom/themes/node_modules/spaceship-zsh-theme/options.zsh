...
# PROMPT
SPACESHIP_PROMPT_SYMBOL="➜" # deprecated, use SPACESHIP_CHAR_SYMBOL
SPACESHIP_PROMPT_ADD_NEWLINE=true
SPACESHIP_PROMPT_SEPARATE_LINE=true
SPACESHIP_PROMPT_FIRST_PREFIX_SHOW=false # new option
...
SPACESHIP_DIR_TRUNC_REPO=true # new option
